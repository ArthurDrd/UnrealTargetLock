...
void UTP_WeaponComponent::Fire()
{
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			...
			World->SpawnActor<AUnrealTargetLockProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
		}
	}
...
void UTP_WeaponComponent::AttachWeapon(AUnrealTargetLockCharacter* TargetCharacter)
{
